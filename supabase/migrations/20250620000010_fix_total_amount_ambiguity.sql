-- Fix total_amount ambiguity in create_individual_participant_payment function
-- The variable final_price conflicts with the column total_amount in subqueries

-- Update the create_individual_participant_payment function to fix total_amount ambiguity
